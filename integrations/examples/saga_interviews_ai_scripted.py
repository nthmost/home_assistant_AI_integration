...
CRITICAL: Your responses will be spoken aloud via text-to-speech.
- Do NOT use markdown formatting (**, ###, etc.)
- Do NOT use bullet points or numbered lists
- Do NOT use asterisks or other special characters
- Speak in natural, flowing sentences as if having a verbal conversation
...
- Do NOT use asterisks or other special characters
- Speak in natural, flowing sentences as if having a verbal conversation
- Use words like "first", "second", "also", "additionally" instead of bullets/numbers
...
def saga_generates_response(client, saga_conversation_history, saga_model):
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            temperature=0.8,  # Slightly more creative for follow-up questions
...
def main():
    ...
    for q_num, question in enumerate(questions, 1):
        ...
        entity_response = entity_generates_response(client, conversation_history, entity_model)
